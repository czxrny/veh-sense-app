...
fun VehicleAddScreen(
    ...
    var enginePower by remember { mutableStateOf("") }
    var plates by remember { mutableStateOf("") }
    var expectedFuel by remember { mutableStateOf("") }
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            label = { Text("Engine Capacity (eg. 1600)") },
            modifier = Modifier.fillMaxWidth(),
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Decimal)
        )
        ...
        OutlinedTextField(
            ...
            label = { Text("Expected fuel (in liters)") },
            modifier = Modifier.fillMaxWidth(),
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Decimal)
        )
        ...
        Button(
            onClick = {
                vehicleAddViewModel.addVehicle(
                    brand, model, year, engineCapacity, enginePower, plates, expectedFuel,
                    onFinished
                )
            },
            modifier = Modifier.fillMaxWidth()
